...
<section class="innerbanner services-banner">
    <div class="banner-info">
        ...
        <h5><a href="index.blade.php">Home</a> / <a href="services.blade.php">Services</a> / Airport Transfer</h5>
    </div>
</section>
<section class="services-inner section-break">
    <div class="tour inner-tour">
        <div class="container">
            <div class="row">
                <div class="col-md-8">
                    ...
                    <div class="btn-wrap">
                        <a href="index.blade.php#book" class="btn btn-default1">Book Now</a>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="picture">
                        <img src="assets/images/bg14.jpg">
                    </div>
                </div>
            </div>
        </div>
...
<section class="why section-break services-inner-why">
    <div class="container">
